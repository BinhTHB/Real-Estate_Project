...
PropertyDataFrame = DagsterType(
    ...
    type_check_fn=lambda _, value: isinstance(value, list) or (hasattr(value, 'columns') and hasattr(value, 'to_dict')),
    description="A List or DataFrame with scraped Properties with id, last_normalized_price and search criterias wich it was found.",
)
